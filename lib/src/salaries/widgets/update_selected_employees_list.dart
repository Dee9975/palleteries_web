...
class UpdateSelectedEmployeesList extends StatelessWidget {
  const UpdateSelectedEmployeesList({
    Key? key,
                ...
                children: [
                  ...
                  Expanded(
                    child: FormBuilderDateTimePicker(
                      name: 'date',
                      onChanged: (DateTime? t) => UpdateSalariesController
                          .to.selectedDateTime = t ?? DateTime.now(),
                      inputType: InputType.date,
                      initialValue:
                          UpdateSalariesController.to.selectedDateTime,
            ...
            Padding(
              ...
              child: DropdownSearch<Employee>(
                ...
                onFind: (String? filter) async {
                  final list = <Employee>[];
                  for (var element in UpdateSalariesController.to.employees) {
                ...
                onChanged: (e) {
                  UpdateSalariesController.to.addEmployee(e!);
                },
                ...
                //   );
                // },
                items: UpdateSalariesController.to.employees,
              ),
            ),
            const SizedBox(
              height: 24.0,
            ...
            Padding(
              ...
              child: FormBuilder(
                child: FormBuilderDropdown(
                  name: "brigade",
                  initialValue: UpdateSalariesController.to.selectedBrigade,
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    labelText: "Brigade",
                  ),
                  items: [
                    ...UpdateSalariesController.to.brigades.map(
                      (e) => DropdownMenuItem(
                        child: Text(e.name),
                        value: e,
                      ),
