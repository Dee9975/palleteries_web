...
class UpdatePlankList extends StatelessWidget {
  const UpdatePlankList({
    Key? key,
              ...
              (e) => GestureDetector(
                onTap: () => Get.dialog(
                  AlertDialog(
                    ...
                    content: FormBuilder(
                      key: UpdateSalariesController.to.plankEditFormKey,
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              UpdateSalariesController.to.updatePlank(e.id);
                              Get.back();
                            },
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            UpdateSalariesController.to.removePlank(e);
                          },
